...
| **Dec 7, 2025**  | NLP Text Classification & Model Deployment Tasks| This assignment focuses on key NLP tasks: comparing vectorization methods, tuning models with GridSearchCV, testing n-grams, deploying a FastAPI inference API.| [NLP Classification](Assignment2/NLP_Preprocessing (1)) |
